                ...
                <form method="POST" action="{{ route('tasks.update', $task) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <x-textarea id="description" name="description"
                            rows="5">{{ old('description', $task->description) }}</x-textarea>
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="due_date" name="due_date" type="date" :value="old('due_date', $task->due_date->format('Y-m-d'))" required />
